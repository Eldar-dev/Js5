...
function stateChangeTimer(){
    var startTime = function(){
        time[0]++;
        getTime();
        document.querySelector('#stopwatch tt').innerHTML = timeString;
    }
    if(flag == false){
...
function splitTimer(){
    if(document.querySelector('#stopwatch tt').innerHTML != "00:00:00.00" && flag == true){
        ...
        interval.innerHTML = /*'1    ' +*/ document.querySelector('#stopwatch tt').innerHTML;
...
function showInstal() {
    ...
    newText.innerHTML = document.querySelector('h4').innerHTML;}*/
...
function resetTimer(){
    ...
    flag = true;
    stateChangeTimer();
    document.querySelector('#stopwatch tt').innerHTML = "00:00:00.00";
    stateChange.innerHTML = "Старт";
    time = [0,0,0,0];
    /*showInstal();*/
}
